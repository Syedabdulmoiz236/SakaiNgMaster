...
@Component({
  selector: 'app-others-financial',
  templateUrl: './others-financial.component.html',
  styleUrls: ['./others-financial.component.scss'],

})

export class OthersFinancialComponent implements OnInit {
  formValue !: FormGroup ;
